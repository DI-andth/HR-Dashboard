...
# ==========================================
# 4. TÍNH TOÁN CÁC BIẾN TOÀN CỤC CHỐNG NAMEERROR
# ==========================================
df_base = df.copy()
...
# 4.1. Nhân sự đang làm việc (Tính đến năm phân tích)
...
# 4.3. Turnover Rate (Chỉ tính nhân sự chính thức)
is_intern_ctv = (
